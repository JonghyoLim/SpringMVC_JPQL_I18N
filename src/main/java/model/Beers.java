...
@NamedQueries({
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    @NamedQuery(name = "Beers.findByName", query = "SELECT b FROM Beers b WHERE b.name LIKE :name"),
    @NamedQuery(name = "Beers.findByNameLikeConcat", query = "SELECT b FROM Beers b WHERE b.name LIKE CONCAT('%', :name,'%')"),
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
